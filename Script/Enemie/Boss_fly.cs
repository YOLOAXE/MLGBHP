...
{
	[SerializeField] private float bossCurrentLife,bossMaxLife,vitesseRotation,VitesseDeplacement,vitesseRotatCou;
	[SerializeField] private GameObject[] travelPoint;
	[SerializeField] private GameObject VuePoint;
	[SerializeField] private Transform attaque;
	[SerializeField] private RectTransform BarDeVie;
	[SerializeField] private bool Move,SeePlayer,isDead;
	[SerializeField] private Animator m_AnimatorDragon;
	private Vector3 PointerPosition,BossPosdepart;
