...
public class StrafeMovement : MonoBehaviour
{
    ...
    private float maxSpeedSprintVar = 0f;
    private float maxSpeedVar = 0f;
    [SerializeField] private float maxAirSpeed = 1f;
    [SerializeField] private float friction = 8f;
    [SerializeField] private float jumpForce = 5.5f;
    [SerializeField] private LayerMask groundLayers = 1;
    [SerializeField] private SoundFootstep[] sfs_FootstepSounds = null;
    [SerializeField] private AudioClip m_JumpSound = null;
    [SerializeField] private AudioClip m_LandSound = null;
    [SerializeField] private bool m_IsWalking = false, m_IsCrouch = false;
    [SerializeField] private float m_StepInterval = 0.5f;
    [Range(0f, 1f)] [SerializeField] private float m_RunstepLenghten = 0.5f;
    ...
    private float VelociteMagnitudePlayer = 0f;
    private float HelpJumpSound = 0f;
    private int Id_FootstepSounds = 0;
    private bool OtherFootstepGround = false;
    [SerializeField] private float DistanceOnground = 0f;
    [SerializeField] private float TempsDeChute = 0f;
    [SerializeField] private bool Escalier = false;
    [SerializeField] private Animator m_AnimatorCharacter = null;
    [SerializeField] private GameObject CharacterePlayer = null;
