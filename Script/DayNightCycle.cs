...
namespace UnityEngine.PostProcessing
{
    ...
    public class DayNightCycle : MonoBehaviour
    {
        ...
        [Range(0, 1)] public float currentTimeofDay = 0.5f; //l'heure actuelle sur une échelle de 0 à 1
        ...
        [SerializeField] private PostProcessingProfile profileJour = null;
        [SerializeField] private PostProcessingProfile profileNuit = null;
        private PostProcessingBehaviour shader = null;
        private float AbianceVolume = 0.5f;
        [HideInInspector] public float timeMultiplier = 1f; //variable permettant de faire avancer le temps
        [HideInInspector] public bool AntiSpamSond = true;
        ...
        void Start()
        {
            ...
            shader = GameObject.FindWithTag("player").transform.GetChild(0).GetComponent<PostProcessingBehaviour>();
