...
//
pnj veut faire du commerce avec vous, voulez-vous accepter la demande?
//
declined the trade.
//
Vous avez besoin de x {2} {1} pour créer cette recette
//
Vous avez appris une nouvelle compétence! Utilisez-le pour vous défendre contre les ennemis. Appuyez sur (K) pour ouvrir le menu des compétences et faites glisser la compétence vers les raccourcis situés en bas.
//
Bienvenue dans mon magasin, êtes-vous intéressé par un article?
//
...
//
Félicitations! Maintenant vous êtes prêt à explorer l'arbre mere, pensez toujours à prendre des potions avec vous.
//
...
//
J'ai vécu de nombreuses années dans cette forêt et je n'ai jamais parlé à un humain, as-tu aussi une queue?, Je plaisante!, Qu'est-ce qu'on t'offre peu?
//
...
//
mon fils, n'avez-vous pas encore couché? ou il est
//
Je vois que vous vous levez tôt pour vous entraîner, cela semble être une bonne décision mais vous ne devez pas oublier vos obligations.
//
...
//
Vous devez terminer la mission de Jakuro avant de commencer cette mission.